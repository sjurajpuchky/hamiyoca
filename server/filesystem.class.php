...
class FileSystem {
    ...
    static function write($myFile, $data) {
    ...
    static function fappend($myFile, $data) {
    ...
    static function emu_getallheaders() { 
